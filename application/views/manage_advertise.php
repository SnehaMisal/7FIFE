            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="" class="">
                                <label class="form-label">Update Advertise Show Timing</label>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <h6 class="mb-0">Advertise Status</h6>
                                <div class="fs-5 ms-auto dropdown">
                                    <input type="checkbox" checked data-toggle="toggle" data-on="ON" data-off="OFF"
                                        data-onstyle="success" data-offstyle="danger" data-size="md">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-header b-l-primary">
                            ...
                            <!-- <div class="media media-dashboard">
                                <div class="media-body">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal"
                                        data-bs-target="#add_model">
                                        <i class="bi bi-plus-lg"></i> Add Subscription Advertise</button>
                                </div>
                            </div> -->
                        </div>
                            ...
                            <div class="table-responsive custom-scrollbar ">
                                <table class="table table-border text-center table-hover " id="myTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td class="default_color">Advertise 1</td>
                ...
                <form class="needs-validation" novalidate="" method="post">
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <!-- Advertise  -->
                            <div class="col-md-6">
                                <label class="form-label" for="img_video">Advertise as<span
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="video_modelLabel">Advertise Video</h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
