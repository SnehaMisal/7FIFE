...
<body>
    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 justify-content-between">
                <div class="breadcrumb-title pe-3">Add Artist</div>
                    ...
                    <div class="card ">
                        <div class="card-header b-l-primary">
                            <div class="d-flex align-items-center">
                                <h6 class="mb-0">Artist List</h6>
                                <div class="fs-5 ms-auto dropdown">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal"
                                        data-bs-target="#add_model">
                                        <i class="bi bi-plus-lg"></i> Add New Artist</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive custom-scrollbar ">
                                <table class="table table-border text-center table-hover " id="myTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td class="default_color">Lata Maneshkar</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td class="default_color">Kishore Kumar</td>
                                            <td>
                                                <div class="lightgallery">
                                                    <a href="<?php echo base_url(''); ?>assets/image/demo_img.jpg"
                                                        data-exthumbimage="<?php echo base_url(''); ?>assets/image/demo_img.jpg"
                                        ...
                                        <tr>
                                            <td>3</td>
                                            <td class="default_color">Alka Yagnik</td>
                                            <td>
                                                <div class="lightgallery">
                                                    <a href="<?php echo base_url(''); ?>assets/image/demo_img.jpg"
                                                        data-exthumbimage="<?php echo base_url(''); ?>assets/image/demo_img.jpg"
                                        ...
                                        <tr>
                                            <td>4</td>
                                            <td class="default_color">Mohammed Rafi</td>
                                            <td>
                                                <div class="lightgallery">
                                                    <a href="<?php echo base_url(''); ?>assets/image/demo_img.jpg"
                                                        data-exthumbimage="<?php echo base_url(''); ?>assets/image/demo_img.jpg"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header card_header_bg_2">
                    <h5 class="modal-title" id="add_modelLabel">Add Artist</h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="text" name="" placeholder="Enter Artist Name"
                                    value="" required="">
                                <div class="invalid-feedback">Please Enter Artist Name.</div>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Artist Image<span class="text-danger">*</span></label>
                                <input name="" type="file" id="adv_img" class="dropify" data-default-file="" data-height="200" data-allowed-file-extensions="png jpg" />
                                <div class="invalid-feedback">Please Enter Artist Image.</div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="edit_model" tabindex="-1" role="dialog" aria-labelledby="edit_modelLabel"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header card_header_bg_2">
                    <h5 class="modal-title" id="add_modelLabel">Edit Artist</h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="needs-validation" novalidate="" method="post">
                    <div class="modal-body">
