...
<head>
    ...
    <title>7FIFE - Add Sub-Categories</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 justify-content-between">
                <div class="breadcrumb-title pe-3">Add Sub-Categories</div>
                    ...
                    <div class="card ">
                        <div class="card-header b-l-primary">
                            <div class="d-flex align-items-center">
                                <h6 class="mb-0">Sub-Categories List</h6>
                                <div class="fs-5 ms-auto dropdown">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal"
                                        data-bs-target="#add_model">
                                        <i class="bi bi-plus-lg"></i> Add New Sub-Categories</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-border text-center table-hover " id="myTable">
                                    <thead>
                                        <tr class="border-bottom-primary">
                                            ...
                                            <th> <span>Sub-Categories Image</span></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>Devotional</td>
                                            <td class="default_color">Popular Devotional Playlists</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td>Podcasts</td>
                                            <td class="default_color">Punjabi Bhakti</td>
                                            <td>
                                                <div class="lightgallery">
                                                    <a href="<?php echo base_url(''); ?>assets/image/demo_img.jpg"
                                                        data-exthumbimage="<?php echo base_url(''); ?>assets/image/demo_img.jpg"
                                        ...
                                        <tr>
                                            ...
                                            <td class="default_color">Carnatic Music</td>
                                            <td>
                                                <div class="lightgallery">
                                                    <a href="<?php echo base_url(''); ?>assets/image/demo_img.jpg"
                                                        data-exthumbimage="<?php echo base_url(''); ?>assets/image/demo_img.jpg"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header card_header_bg_2">
                    <h5 class="modal-title" id="add_modelLabel">Add Sub-Categories</h5>
                ...
                <form class="needs-validation" novalidate="" method="post">
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <label class="form-label">Sub-Categories Name<span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="" placeholder="Enter Sub-Categories Name"
                                    value="" required="">
                                <div class="invalid-feedback">Please Enter Sub-Categories Name.</div>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Sub-Categories Image<span class="text-danger">*</span></label>
                                <input name="" type="file" id="adv_img" class="dropify" data-default-file="" data-height="200" data-allowed-file-extensions="png jpg" />
                                <div class="invalid-feedback">Please Enter Sub-Categories Image.</div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="edit_model" tabindex="-1" role="dialog" aria-labelledby="edit_modelLabel"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header card_header_bg_2">
                    <h5 class="modal-title" id="add_modelLabel">Edit Sub-Categories</h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="needs-validation" novalidate="" method="post">
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <label class="form-label">Sub-Categories Name<span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="" placeholder="Enter Sub-Categories Name"
                                    value="Popular Devotional Playlists" required="">
                                <div class="invalid-feedback">Please Enter Sub-Categories Name.</div>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Sub-Categories Image<span class="text-danger">*</span></label>
