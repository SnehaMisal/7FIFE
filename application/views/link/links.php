<link rel="icon" href="<?php echo base_url() ?>assets/image/favicon_1.png" type="image/png" />
<!--plugins-->
...
<link rel="stylesheet" type="text/css"
    href="<?php echo base_url() ?>assets/plugins/bootstrap4-toggle/bootstrap4-toggle.min.css">
