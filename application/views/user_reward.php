    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 justify-content-between">
                <div class="breadcrumb-title pe-3">User Reward</div>
                <div class="ps-3 bread_path">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">User Reward</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card shadow-sm border-0 overflow-hidden">
                        <div class="card-body">
                            <div class="profile-avatar text-center">
                                <img src="<?php echo base_url() ?>assets/image/admin_profile.jpg"
                                    class="rounded-circle shadow" width="120" height="120" alt="">
                            </div>

                            <div class="text-center mt-4">
                                <h4 class="mb-1">Jhon Deo</h4>
                                <p class="mb-0 text-secondary">demo@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header">
                            <ul class="nav nav-pills nav-fill nav-justified" id="pills-tab" role="tablist">
                                <li class="nav-item px-2" role="presentation">
                                    <a href="<?php echo base_url('user_profile') ?>" class="nav-link ">Subscription
                                        Plan</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a href="<?php echo base_url('user_reward') ?>" class="nav-link active">Reward</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="p-l-0  pr-0 b-l-primary b-b-primary">
