    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3 justify-content-between">
                <div class="breadcrumb-title pe-3">Edit Song</div>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select select2" id="img_video" required="">
                                            <option selected="" disabled="" value="">Choose...</option>
                                            <option value="1" selected>Mahashivratri</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="text" name="" placeholder="Enter Song Title"
                                            value="Mere Bhole Nath" required="">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-select select2" id="img_video" required="" multiple>
                                            <option value="1" selected>Lata Maneshkar</option>
                                            <option value="2" selected  >Kishore Kumar</option>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input name="" type="file" id="adv_img" class="dropify" data-default-file="<?php echo base_url(''); ?>assets/image/song_img.jpg"
